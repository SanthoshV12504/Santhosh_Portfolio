import { ExternalLink, Bot, Newspaper, LayoutDashboard } from 'lucide-react';
...
const projects = [
  {
    ...
    description: 'A comprehensive AI-powered financial management dashboard tracking net worth, income, and expenses with real-time insights and advanced data visualization.',
    icon: LayoutDashboard,
    tags: ['Finance', 'Dashboard', 'Data Visualization', 'AI Insights'],
